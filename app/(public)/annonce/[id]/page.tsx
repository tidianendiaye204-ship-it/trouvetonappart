...
export default async function AnnoncePage({
  ...
  // Incrémenter le compteur de vues de façon asynchrone (ne bloque pas le rendu)
  supabase.rpc('increment_vues_bien', { p_bien_id: id }).then(({ error }) => {
    if (error) console.error("Erreur increment_vues:", error)
  })
          ...
          <div className="relative">
            <div className="sticky top-24 space-y-6">
              <div className="bg-white rounded-3xl shadow-xl border border-ardoise-gris/10 p-6 sm:p-8">
                ...
                {/* Boutons Contact Direct (Avec Tracking) */}
